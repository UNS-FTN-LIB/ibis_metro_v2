...
Operativni sistemi žrtve i napadača podignuti su na virtuelnoj mašini kako bi se osigurala sigurnost. Operativni sistem žrtve je Windows 10, dok je operativni sistem napača Kali Linux. Softver koji je korišćen u napadu je Oracle VM VirtualBox.
...
![Primer screenshot-a](screenshot.png)

&ensp;&ensp;2. Zatim, potrebno je preuzeti nishang repozitorijum: [nishang](https://github.com/samratashok/nishang)
...
&ensp;&ensp;4. Nakon toga, potrebno je uneti komandu koja će kreirati maliciozni word dokument. Potrebno je izmeniti dve IP adrese u komandi na adresu napadača, kao i definisati putanju gde će se sačuvati fajl i dodeliti mu proizvoljno ime
